...
var builtPaths = (['js/'] || __karma__.config.builtPaths || ['js/'])
    .map(function(p) { return '/base/'+p;});
// console.log("buildPaths", builtPaths);
...
// console.log("window.__karma__.files =", Object.keys(window.__karma__.files).filter( path => path.indexOf( "/base/node_modules" ) === -1 ) );
